...
models.model.rootANOMALY.Head2.Emissive:setPrimaryRenderType("EMISSIVE")
...
local AnomalyKey = keybinds:newKeybind("sorrow swap", "key.keyboard.h")
...
function events.tick()
    ...
    animations.model.weep:setPlaying(crouching)
end